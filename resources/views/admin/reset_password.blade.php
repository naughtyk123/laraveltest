                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center gradient-aqua-marine">
                        <div class="card px-4 py-2 box-shadow-2 ">
                            <div class="card-header text-center">
                                ...
                                <h4 class=" text-bold-400 grey darken-1"> Reset your Password</h4>
                                ...
                                <div class="card-block">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="password" class="form-control" name="primary_password" id="primary_password" placeholder="Password" required >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="text-center col-md-12">
                                                <button onclick="resetpassword()"type="button" class="btn btn-success px-4 py-2 white font-small-4 box-shadow-2 border-0">Change Password</button>
                                            </div>        
                                        </div>
        ...
        function resetpassword() {
            $.ajax({
                ...
                data: {
                    ...
                    "_token": "{{ csrf_token() }}",
                    "primary_password": $('#primary_password').val(),
